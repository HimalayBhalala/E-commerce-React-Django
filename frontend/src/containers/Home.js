    ...
    <div>
        <div className='container'>
            <div className="row mt-3">
                <h3 className='mb-4'>Latest Products <Link to="/products" className='float-end btn btn-sm' style={{backgroundColor:"darkslategrey",color:"white"}}>View All Products <i className='fa-solid fa-arrow-right-long'></i></Link></h3>
                <div className="row">
            ...
            <h3 className='mb-4'>Popular Categories <Link to="/categories" className='float-end btn btn-sm' style={{backgroundColor:"darkslategrey",color:"white"}}>View All Categories <i className='fa-solid fa-arrow-right-long'></i></Link></h3>
            <div className="row">
            {
